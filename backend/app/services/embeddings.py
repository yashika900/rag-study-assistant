...
Gemini is still used for answer generation in llm.py.
This file is only for document/query embeddings used by retrieval.
"""
...
# The model is downloaded once, then loaded from cache. These flags prevent
# fresh backend processes from hanging while checking Hugging Face online.
